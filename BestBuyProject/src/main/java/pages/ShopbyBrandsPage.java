...
public class ShopbyBrandsPage extends Utils {
...
public void shopbrd2() throws Exception {
	...
	smphnndwtch.click();
	jstypetext(smphnndwtch, "Passed", "SmartPhone and Watches");
	Thread.sleep(3000);
}
...
public void shopdpt3() throws Exception {
	...
	smphn.click();
	jstypetext(smphn, "Passed", "Mobile Phones");
	Thread.sleep(3000);
	lrnmre.click();
	shpnw.click();
	jstypetext(shpnw, "Passed", "Shop Now");
	Thread.sleep(5000);
}
