...
public class Utils {
	...
	public static void getpropvalue() throws Exception {
		...
		driver.get(url);
		WebElement selectstate = driver.findElement(By.xpath("//div[@class='country-selection']"));
		selectstate.click();
		
		WebElement feedback = driver.findElement(By.xpath("//style[@type='text/css']"));
	...
	public void extentreportStarter() {
		try {
			...
			extent = new ExtentReports("BestBuyreport.html", true);
